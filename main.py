...
from stats import Player_Manager
from stats import Squad
from stats import Squad_Manager
...
for i in list_Squad_result:
    s = squad_manager.find_squad(i[0])
    if s == None:
        new_s=Squad(*i[0:4])
...
from stats import header2, row2
